...
void CGlock::GlockFire(float flSpread, float flCycleTime, bool fUseAutoAim)
{
	...
	Vector vecDir;
	vecDir = m_pPlayer->FireBulletsConsistent(1, vecSrc, vecAiming, Vector(flSpread, flSpread, flSpread), 8192, BULLET_PLAYER_9MM, 0, 0, m_pPlayer->pev, m_pPlayer->random_seed); // Effectively makes the glock 100% accurate
