...
void CShotgun::PrimaryAttack()
{
	...
	else
	{
		...
		vecDir = m_pPlayer->FireBulletsConsistent(6, vecSrc, vecAiming, VECTOR_CONE_7DEGREES, 2048, BULLET_PLAYER_BUCKSHOT, 0, 0, m_pPlayer->pev, m_pPlayer->random_seed);
	}
...
void CShotgun::SecondaryAttack()
{
	...
	else
	{
		...
		vecDir = m_pPlayer->FireBulletsConsistent(12, vecSrc, vecAiming, VECTOR_CONE_10DEGREES, 2048, BULLET_PLAYER_BUCKSHOT, 0, 0, m_pPlayer->pev, m_pPlayer->random_seed);
	}
